...
def generate_hmap(instances, image):
    ...
    for instance in instances:
        ...
        box_points = cv2.boxPoints(((x_center, y_center), (w, h), rot_angle))
        ...
        sigma1 = 0.3 * ((w-1) * 0.5 - 1) + 0.8
        sigma2 = 0.3 * ((h-1) * 0.5 - 1) + 0.8
        ...
        g = g1 * g2 * patch_weight  # gaussian heatmap
